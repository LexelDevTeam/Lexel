...
static dev::h256 const c_genesisStateRootLexel;
static std::string const c_genesisJsonLexel = std::string() +
R"E(
{
	"nonce": "0x0",
	"difficulty": "0x0",
...
static std::string const c_configJsonLexel = std::string() +
R"E(
{
